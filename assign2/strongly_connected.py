...
# 1. G' is the reverse graph of G
# 2. find the vertex with the highest postorder number in G'.
#    this vertex l is in a sink SCC_1 in G
# 3. dfs on l in G to find all the vertices in the SCC of l
# 4. remove the sink vertices of SCC_1 from G'
...
class DirectedSCC:
    ...
    def number_of_strongly_connected_components(self, adj):
    ...
    def do(self):
        ...
        print(self.number_of_strongly_connected_components(adj))
